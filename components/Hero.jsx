    ...
    return <>
        ...
        md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:1/2">
                ...
                />
                <h1 className="hover-heading bold-52 lg:bold-88">Siwa Oasis Camp Area</h1>
            ...
            <div className="relative flex flex-1 items-start">
                <div className="relative z-20 w-[268px] bg-green-90 flex flex-col gap-8 rounded-3xl px-7 py-8">
                    <div className="flex flex-col">
                        <div className="flexBetween">
                            <p className="regular-16 text-gray-20">Location</p>
                            <Image src="/close.svg" alt="close" width={24} height={24} />
                        </div>
                        <p className="bold-20 text-white">Dahab</p>
                    </div>
