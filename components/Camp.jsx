...
import { PEOPLE_URL } from '../constants/index.js'

const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }) => {
  return <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat 
    ...
    flex flex-col py-10 lg:py-20 lg:mb-10 xl:mb-20`}>
      ...
      overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        <CampSite
          ...
          title="Dolphin Camp & Diving"
          subtitle="El Mashraba St, Dahab, South Sinai"
          peopleJoined="100+ Joined"
        />
      </div>
